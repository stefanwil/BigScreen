...
namespace BigScreen.Migrations
{
    ...
    partial class BigScreenContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BigScreen.Models.Seat", b =>
                {
                    ...
                    b.Property<int>("SeatHeightInt")
                        .HasColumnType("INTEGER");

                    b.Property<string>("SeatWidth")
                        .HasColumnType("TEXT");

                    b.Property<int>("SeatWidthInt")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BigScreen.Models.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BigScreen.Models.Tifo", b =>
                {
                    ...
                    b.HasIndex("TifoGroupId");

                    b.ToTable("Tifo");
                });

            modelBuilder.Entity("BigScreen.Models.TifoGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("TifoGroupName")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BigScreen.Models.Tifo", b =>
                {
                    b.HasOne("BigScreen.Models.TifoGroup", null)
                        .WithMany("Tifos")
                        .HasForeignKey("TifoGroupId");
                });
